...
int main()
{
	...
	Shader textShader("shaders/text/vertShader.glsl", "shaders/text/fragShader.glsl");
 ...
 // ------------------------------------------------------------------
    ...
    textShader.use();
    glm::mat4 projectionText = glm::ortho(0.0f, static_cast<GLfloat>(SCR_WIDTH), 0.0f, static_cast<GLfloat>(SCR_HEIGHT));
    textShader.setMat4("projection", projectionText);
	textShader.setInt("text", 0);

	// 配置VAO/VBO用于纹理字形 quads
    GLuint tVAO, tVBO;
    ...
    while (!glfwWindowShouldClose(window))
    {
		...
		// render text
		RenderText(textShader, "This is sample text", 25.0f, 25.0f, 1.0f, glm::vec3(0.5, 0.8f, 0.2f), tVAO, tVBO);
